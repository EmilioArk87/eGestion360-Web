...
namespace eGestion360Web.Pages.Flota.Operacion.OdometroDiario
{
    public class CreateModel : PageModel
    {
        ...
        [BindProperty] public Models.Flota.OdometroDiario Item { get; set; } = new();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Item.KmFinal < Item.KmInicial)
            {
                ModelState.AddModelError("Item.KmFinal", "El KM final no puede ser menor al inicial.");
                await CargarSelectsAsync();
                return Page();
            }
            ...
            _db.OdometrosDiarios.Add(Item);
            await _db.SaveChangesAsync();
            TempData["Mensaje"] = $"Odómetro registrado para {Item.Fecha:dd/MM/yyyy}.";
